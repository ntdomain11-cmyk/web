          ...
          <div className="nt-aboutPage__introGrid">
            <div>
              ...
              <p className="nt-aboutPage__text">
                {intro?.text ||
                  'NT Consultancy is a business growth and consulting practice focused on helping MSMEs build clarity, improve systems, and execute consistently.'}
              </p>
              <p className="nt-aboutPage__text">
                NT Consultancy is led by Nirajkumar Trivedi and supported by a dedicated team to help you implement, review, and scale.
              </p>
              <p className="nt-aboutPage__text">
                We work with owners and leadership teams to strengthen strategy, marketing, sales, operations, and people performance.
              </p>

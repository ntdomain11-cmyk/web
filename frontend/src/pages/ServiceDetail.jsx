...
export default function ServiceDetail() {
  ...
  if (!service) {
    return (
      <div className="nt-serviceDetail nt-serviceDetail--notFound">
        <div className="nt-serviceDetail__container">
          <div className="nt-serviceDetail__notFoundCard">Loading…</div>
        </div>
      </div>
    )
  }
      ...
      <section className="nt-serviceDetail__hero">
        <div className="nt-serviceDetail__container">
          ...
          <div className="nt-serviceDetail__heroGrid">
            ...
            <div className="nt-serviceDetail__right">
              {service.thumbnailUrl ? (
                <div className="nt-serviceDetail__thumbWrap">
                  <img className="nt-serviceDetail__thumb" src={service.thumbnailUrl} alt={service.title} loading="lazy" />
                </div>
              ) : null}

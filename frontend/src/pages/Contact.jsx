...
const DEFAULT_MAP_EMBED_URL = 'https://www.google.com/maps?q=Amreli%2C%20Gujarat%2C%20India&output=embed'
...
export default function Contact() {
  ...
  const mapUrl = siteConfig?.mapEmbedUrl || DEFAULT_MAP_EMBED_URL
          ...
          <div className="nt-contact__grid">
            ...
            <div className="nt-contact__formCard">
              <form onSubmit={onSubmit} noValidate>
                ...
                <button className="nt-contact__submit" type="submit">
                  SEND MESSAGE
                </button>
              </form>
            </div>

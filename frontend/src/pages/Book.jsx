      ...
      <section className="nt-book__hero">
        <div className="nt-book__heroGrid">
          ...
          <div id="booking" className="nt-book__formCard">
            ...
            {submitError ? <p className="nt-book__error" style={{ marginBottom: 10 }}>{submitError}</p> : null}
            ...
            <form className="nt-form" onSubmit={onSubmit} noValidate>
              ...
              <button type="submit" className="nt-primaryBtn" disabled={busy} style={busy ? { opacity: 0.85, cursor: 'not-allowed' } : null}>

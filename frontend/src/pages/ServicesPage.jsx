            ...
            {list.map((s) => {
              return (
                <article key={s.slug} className="nt-services__card">
                  <div className="nt-services__thumbWrap">
                    {s.thumbnailUrl ? (
                      <img className="nt-services__thumb" src={s.thumbnailUrl} alt={s.title} loading="lazy" />
                    ) : null}
                  </div>
                  ...
                  <Link className="nt-services__cardLink" to={`/services/${s.slug}`}>

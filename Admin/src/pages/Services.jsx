          ...
          <div className="nt-field nt-field--full">
            ...
            <input
              ...
              onChange={async (e) => {
                ...
                if (url) onFormChange('thumbnailUrl', url)
              }}
              disabled={uploading}
            />
            {form.thumbnailUrl ? (
              <a href={form.thumbnailUrl} target="_blank" rel="noreferrer" style={{ fontSize: 12, color: 'rgba(4,27,46,0.65)' }}>

...
export default function SiteConfig() {
  ...
  return (
    <div className="nt-adminCard" style={{ padding: 16, display: 'grid', gap: 12 }}>
      ...
      <div className="nt-adminCard" style={{ padding: 14, display: 'grid', gap: 10, boxShadow: 'none' }}>
        <div style={{ fontWeight: 900 }}>Google Reviews</div>
        <div className="nt-formGrid">
          <label className="nt-field">
            <span>Enabled</span>
            <select className="nt-select" value={item.googleReviewsEnabled ? '1' : '0'} onChange={(e) => onChange('googleReviewsEnabled', e.target.value === '1')}>
          ...
          <label className="nt-field">
            ...
            <input className="nt-adminInput" value={item.googlePlaceId || ''} onChange={(e) => onChange('googlePlaceId', e.target.value)} placeholder="ChIJ..." />
          </label>

          <label className="nt-field">
            <span>Section Title</span>
            <input className="nt-adminInput" value={item.googleReviewsTitle || ''} onChange={(e) => onChange('googleReviewsTitle', e.target.value)} placeholder="Google Reviews" />
          </label>
          ...
          <label className="nt-field">
            ...
            <input
              className="nt-adminInput"
              type="number"
              value={item.googleReviewsMax ?? 6}
              onChange={(e) => onChange('googleReviewsMax', Number(e.target.value || 0))}
              min={1}
              max={20}
            />
          </label>
          ...
          <label className="nt-field nt-field--full">
            ...
            <input
              ...
              type="number"
              step="0.5"
              value={item.googleReviewsMinRating ?? 0}
              onChange={(e) => onChange('googleReviewsMinRating', Number(e.target.value || 0))}
              min={0}
              max={5}
            />
          </label>
